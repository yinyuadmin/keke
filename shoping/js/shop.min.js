! function(t, e, a, n) {
  ...
  t.extend(i.prototype, {
    ...
    add_cart_buttons: function() {
      var t = this;
      t.cart.parent().append('<button class="' + t.settings.cart + '-clear">清购</button>'), t.cart.parent().append('<button type="submit" class="' + t.settings.cart + '-checkout">提交</button>'), t.clear_cart(), t.checkout_button()
    },
    checkout: function() {
      var e, a = this,
        n = {
      ...
      t.extend(n, a.settings.paypal), i.attr("action", "db.php"), i.attr("method", "post"), i.attr("target", "_blank");
